...
export const CloseIcon: React.FC<Icon> = ({ styles, className = '' }) => 

    <svg  style={ styles } className={ "bi bi-x " + className } width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
