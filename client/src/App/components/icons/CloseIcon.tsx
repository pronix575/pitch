...
export const CloseIcon: React.FC<Icon> = ({ style }) => 

    <svg  style={ style } className="bi bi-x" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
