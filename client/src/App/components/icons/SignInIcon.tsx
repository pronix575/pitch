...
export const SignInIcon: React.FC<Icon> = ({ style }) => 
    
    <Flex styles={{ minHeight: "18px" }}>
        <svg className={ "bi bi-box-arrow-in-right" } style={ style } width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
